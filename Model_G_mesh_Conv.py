...
for mod in range (0,4):
    ...
    PeriodicBound3DG(mdb,model_name,OY,YXY,XYX,OX,ZYZ,YZXYZ,XYZXZ,XZZ,OZ,YYZ,XZX,XYXYZ,X,XB,Y,YB,Z,ZB,VXYX,VXYZXZ,VYZXYZ,VYXY,VXYXYZ,VXZX,VXB,VYB,VZB)
    #print(mod+1)
    for j in range(0,3):
        #print(direction)
        if j==0:
        #print('G12')
            ...
            Ref_point1='RP-4'; Ref_point2='RP-5'; Ref_point3='RP-6'; C1=Lx*0.005; C2=Ly*0.005; job=job_name
            BC_JOB(step_name,mdb,model_name,Ref_point1,Ref_point2,Ref_point3,C1,C2,job)
        elif j==1:
            #print('G13')
            job_type='-G13'
            job_name=Mod_Num+job_type
            Ref_point1='RP-5'; Ref_point2='RP-4'; Ref_point3='RP-6'; C1=Lx*0.005; C2=Lz*0.005; job=job_name
            BC_JOB(step_name,mdb,model_name,Ref_point1,Ref_point2,Ref_point3,C1,C2,job)
        elif j==2:
			#print('G23')
            job_type='-G23'
            job_name=Mod_Num+job_type
            Ref_point1='RP-6'; Ref_point2='RP-5'; Ref_point3='RP-4'; C1=Ly*0.005; C2=Lz*0.005; job=job_name
            BC_JOB(step_name,mdb,model_name,Ref_point1,Ref_point2,Ref_point3,C1,C2,job)
        else:
            continue
